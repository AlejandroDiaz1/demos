...
Service account creates a new Google Sheets file (from uploaded CSV) and shares it with EMAIL
"""
...
def hello_gcs(cloud_event):
    ...
    try:
        ...
        print(doc_url)
        return f"Google Sheet creado exitosamente con datos del archivo CSV: {doc_url}"
